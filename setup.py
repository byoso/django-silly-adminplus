...
setup(
    ...
    packages=[
        ...
        "django_silly_adminplus.plop.adminplus_plus.migrations",
        "django_silly_adminplus.plop.adminplus_plus.templates",
        "django_silly_adminplus.plop.adminplus_plus.templates._adminplus",
